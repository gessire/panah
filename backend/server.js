...
// Auth (registration, login, session restore)
...
// Keep these last: notFound catches unmatched routes, errorHandler
// catches anything thrown/forwarded by the routes above (including auth).
app.use(notFound);
