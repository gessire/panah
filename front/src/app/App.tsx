...
const TRACKS: Track[] = [
  ...
  },
  {
    ...
    color: "#3888c4",
    img: "/img/rain.jpeg",
    audio: "/audio/baranwithmusic.mp3",
  },
  {
    id: "8",
...
const AFFIRMATIONS = [
  ...
  "امروز را شکرگذاری کن و بخند که دنیا هنوز ادامه دارد",
  "تو لایق آرامش و خوشبختی هستی",
  "اتفاقات خوب در انتظار توست . برو و تلاش کن",
];
